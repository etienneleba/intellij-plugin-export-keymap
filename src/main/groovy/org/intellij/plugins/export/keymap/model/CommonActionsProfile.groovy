...
class CommonActionsProfile extends ActionsProfile {
    ...
    CommonActionsProfile() {
        entries = [
                ...
                new ActionData(id: ['ActivateProjectToolWindow'], description: 'Toggle project structure'),
                new ActionData(id: ['ActivateTerminalToolWindow'], description: 'Toggle terminal'),
                new ActionData(id: ['MainMenu'], description: 'Main menu'),
                new ActionData(id: ['ShowPopupMenu'], description: 'Context Menu'),
                new ActionData(id: ['NewElement'], description: 'New'),
                new ActionData(id: ['RenameElement'], description: 'Rename'),

                // Navigate
                new Header(depth: 0, name: 'NAVIGATE'),

                new ActionData(id: ['RecentFiles'], description: 'Recent files'),
                new ActionData(id: ['Switcher'], description: 'Switcher'),
                new ActionData(id: ['SearchEverywhere']),
                new ActionData(id: ['GotoFile'], description: 'Go to File'),
                new ActionData(id: ['GotoAction'], description: 'Go to Action'),
                new ActionData(id: ['GotoTest'], description: 'Go to Test'),
                new ActionData(id: ['GotoDeclaration'], description: 'Go to Declaration or Usages'),

                // Live template
                new Header(depth: 0, name: 'LIVE TEMPLATE'),

                new ActionData(id: ['InsertLiveTemplate']),
                new ActionData(shortcut: 'fore', description: 'foreach'),
                new ActionData(shortcut: 'forek', description: 'foreach with key'),
                new ActionData(shortcut: 'prif', description: 'private function'),
                new ActionData(shortcut: 'prof', description: 'protected function'),
                new ActionData(shortcut: 'pubf', description: 'public function'),
                ...
                new ActionData(id: ['EditorStartNewLine', 'EditorStartNewLine'], description: 'Start new line above/below'),
                new ActionData(id: ['EditorDeleteLine'], description: 'Delete line'),
                new ActionData(id: ['EditorDeleteToLineStart'], description: 'Delete line to start'),
                new ActionData(id: ['EditorDeleteToWordStart'], description: 'Delete line to word start'),
                new ActionData(id: ['$Cut', '$Copy', '$Paste'], description: 'Cut/Copy/Paste'),
                new ActionData(id: ['$Undo', '$Redo'], description: 'Undo/Redo'),
                new ActionData(id: ['EditorDuplicate'], description: 'Duplicate line or selection'),
                new ActionData(id: ['EditorToggleCase'], description: 'Toggle word case'),
                new ActionData(id: ['ReformatCode'], description: 'Reformat code'),
                new ActionData(id: ['CommentByLineComment', 'CommentByBlockComment'], description: 'Comment with Line/Block Comment'),


                // FIND
                new Header(depth: 0, name: 'FIND'),

                new ActionData(id: ['Find', 'Replace'], description: 'Find/Replace'),
                new ActionData(id: ['FindNext', 'FindPrevious'], description: 'Previous/Next occurrence'),
                new ActionData(id: ['FindWordAtCaret'], description: 'Next Occurrence of the Word at Caret'),
                ...
                // NAVIGATE IN FILE
                new Header(depth: 0, name: 'NAVIGATE IN FILE'),

                //new ActionData(shorcut: 'Caps + JKLM', description: 'Left/Up/Right/Down'),
                new ActionData(id: ['EditorPreviousWord', 'EditorNextWord'], description: 'Previous/Next word'),
                new ActionData(id: ['MoveStatementDown', 'MoveStatementUp'], description: 'Move statement Down/Up'),
                new ActionData(id: ['EditorPreviousWordWithSelection', 'EditorNextWordWithSelection'], description: 'Previous/Next word with selection'),
                new ActionData(id: ['EditorDownWithSelection', 'EditorUpWithSelection'], description: 'Down/Up with selection'),
                new ActionData(id: ['EditorLineStart', 'EditorLineEnd'], description: 'Caret to the Start/Snd of the line'),
                new ActionData(id: ['EditorCodeBlockEnd', 'EditorCodeBlockStart'], description: 'Go to Code Block End/Start'),

                // FILE ACTIONS
                new Header(depth: 0, name: 'FILE ACTIONS'),

                new ActionData(id: ['$SelectAll'], description: 'Select All'),
                new ActionData(id: ['SelectAllOccurrences']),
                new ActionData(id: ['SaveAll']),
                new ActionData(id: ['CloseContent','CloseAllEditors'], description: 'Close / Close all'),
